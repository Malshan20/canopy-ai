...
// The marketing display face. Manrope stays as the marketing UI/label face
// (buttons, cards, small headings) — this is added above it for the large
// editorial headlines only, which is where a high-contrast serif earns its
// keep. Loaded here rather than in the marketing layout because next/font
// requires font loaders to be called at module scope in a layout or page.
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${inter.variable} ${manrope.variable} ${plexMono.variable} ${instrumentSerif.variable}`}
    >
